...
class SelectionSort(Algorithm):
	...
	def sort(self):
		...
		print (" self.trocas:	%02d" % self.troca)
...
class Quicksort(Algorithm):
	...
	def sort(self):
		...
		print (" Comparações: %02d" % self.self.comparacao)
		print (" self.trocas:	%02d" % self.self.troca)
